...
#ifndef REPO_STORAGE_INDEX_MANIFEST_HPP
#define REPO_STORAGE_INDEX_MANIFEST_HPP
...
class IndexManifest : noncopyable
{
public:
  ...
  public:
     ...
     */
    Entry(const Manifest& data, std::string hash);
    ...
    /**
     *  @brief get record hash from database
     */
    std::string
    getHash() const
    {
...
public:
  explicit
  IndexManifest(size_t nMaxPackets);
   ...
   */
  bool
  insert(const Manifest& data, std::string hash);
   ...
   */
  bool
  hasData(const Manifest& manifest) const;
...
#endif // REPO_STORAGE_INDEX_MANIFEST_HPP
